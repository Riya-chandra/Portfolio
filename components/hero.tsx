      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <span className="text-white/80 text-base">
            ABESIT CSE Student | riyachandra on GitHub | Passionate about
            building scalable web applications with React.js, Node.js, Python,
            AI Agents, LangChain, and modern technologies.
          </span>
        </motion.p>

        {/* Hidden SEO Keywords */}
        <div className="sr-only">
          Riya Chandra - Full-Stack Developer from ABES Institute of Technology,
          Ghaziabad, Uttar Pradesh. Software Engineer specializing in React.js,
          Next.js, Node.js, Python, TypeScript, JavaScript, AI/ML, LangChain,
          LangGraph, RAG Systems, AI Agents, Azure OpenAI, AWS, GCP, Docker,
          Kubernetes. riyachandra GitHub profile. LeetCode programmer with 500+
          problems solved. GeeksforGeeks expert. Open source contributor. From
          Patna, Bihar, India. Contact: riyachandra9119@gmail.com,
          +91-9263226570.
        </div>
        ...
        >
          ...
          {/* ✅ Download Resume (NEW BUTTON ADDED IN MIDDLE) */}
          <a
            href="/resume.pdf" // ✅ yaha apni file ka naam
            download
